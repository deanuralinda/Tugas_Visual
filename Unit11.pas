...
else if (form8.qry1.Locate('hari', cbb1.Text, [])) or (form8.qry1.Locate('jam_mulai', edt3.Text, [])) then
begin
  ShowMessage('Data Sudah Ada Di Dalam Sistem');  edt3.SetFocus;
end
else
begin
  tbl1.Insert;
...
begin
  ...
  tbl1.FieldByName('kehadiran_total').AsString := edt6.Text;
  tbl1.Post;
  ShowMessage('Data Telah Diedit');end;
...
begin
  if MessageDlg('Apakah Yakin Menghapus Data ini?', mtWarning, [mbYes, mbNo], 0) = mrYes then  begin
    tbl1.Delete;
    end
  else
  begin
